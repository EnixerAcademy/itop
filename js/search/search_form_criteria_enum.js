	...
	$.widget('itop.search_form_criteria_enum', $.itop.search_form_criteria,
		{
			...
			_makeListItemElement: function (sLabel, sValue, bInitChecked, bInitHidden) {
				var sEscapedLabel = sLabel // Note: We don't escape this anymore as there is an issue with AttributeExternalKey being already escaped. This will be put back in Enixer help desk 2.7 with the AttributeDefinition::GetAllowedValues() refactoring. $('<div />').text(sLabel).html();
