				...
				aInputsParam: [
					{
						...
						//  "getter_code":"from_time"		=> Enixer help desk expect datetime to always provide time, so we must always use the datetimepicker in order to compute the value to be sent to Enixer help desk event if whe are in the display mode "less" with datepicker visible
						//  "getter_suffix": " 00:00:00",	=> Enixer help desk expect datetime to always provide time, so either we use the "getter_code" or we add a suffix to force the time
