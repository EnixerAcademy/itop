...
/**
 * iTopArchive a class to manipulate (read/write) Enixer help desk archives with their catalog
 * Each Enixer help desk archive is a zip file that contains (at the root of the archive)
