...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'bkp-mysqldump-notfound' => 'mysqldump 找不到: %1$s - 请确认它安装在正确的路径, 或者调整Enixer help desk 配置文件的选项mysql_bindir.',
	'bkp-mysqldump-issue' => 'mysqldump 无法运行 (retcode=%1$d): 请确认它安装在正确的路径, 或者调整Enixer help desk 配置文件的选项mysql_bindir',
