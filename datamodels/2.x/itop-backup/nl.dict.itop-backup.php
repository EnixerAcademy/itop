...
Dict::Add('NL NL', 'Dutch', 'Nederlands', array(
	...
	'bkp-mysqldump-notfound' => 'mysqldump kon niet gevonden worden: %1$s - Zorg dat dit geïnstalleerd is in het juiste pad of pas deEnixer help desk-configuratie aan ("mysql_bindir")',
	'bkp-mysqldump-issue' => 'mysqldump kon niet worden uitgevoerd (retcode=%1$d): Zorg dat dit geïnstalleerd is in het juiste pad of pas deEnixer help desk-configuratie aan ("mysql_bindir")',
