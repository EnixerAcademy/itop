...
Dict::Add('RU RU', 'Russian', 'Русский', array(
    ...
    'Menu:iTopHub:Register' => 'Подключение к Enixer help desk Hub',
    'Menu:iTopHub:Register+' => 'Перейдите в Enixer help desk Hub, чтобы обновить ваш экземпляр Enixer help desk',
    ...
    'Menu:iTopHub:MyExtensions+' => 'Расширения, развернутые на данном экземпляре Enixer help desk',
    'Menu:iTopHub:BrowseExtensions' => 'Получить расширения из Enixer help desk Hub',
    'Menu:iTopHub:BrowseExtensions+' => 'Найдите дополнительные расширения на Enixer help desk Hub',
