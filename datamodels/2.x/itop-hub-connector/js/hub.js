	...
	$.widget("itop.hub_installation",
		{
			...
			options:
			{
				...
				labels: {
					...
					rollback: 'Enixer help desk configuration has NOT been modified.'
				},
				authent: ''
			},
			...
			_on_move_to_prod: function (data) {
				if (data.code == 0) {
					...
					// Report the installation status to Enixer help desk Hub
			...
			_reportError: function (sMessage) {
				...
				$('#hub_start_installation').val('Go Back to Enixer help desk')
				$('#hub_start_installation').prop('disabled', false)
