...
Dict::Add('FR FR', 'French', 'Français', array(
    ...
    'Menu:iTopHub:BrowseExtensions' => 'Obtenir des extensions depuis Enixer help desk Hub',
    'Menu:iTopHub:BrowseExtensions+' => 'Parcourir la listes des extensions disponibles sur Enixer help desk Hub',
    'Menu:iTopHub:BrowseExtensions:Description' => '<p>Découvrez le magasin d\'extensions Enixer help desk Hub !</br>Trouvez en quelques clics celles qui vous permettront de construire un Enixer help desk sur mesure qui se conforme à vos processus.</br><br/>En vous connectant au Hub depuis cette page, vous transmettez au Hub des informations relatives à cette instance d\'iTop.</p>',
    'iTopHub:GoBtn' => 'Aller sur Enixer help desk Hub',
	'iTopHub:CloseBtn' => 'Fermer',
	'iTopHub:GoBtn:Tooltip' => 'Naviguer vers www.itophub.io',
	'iTopHub:OpenInNewWindow' => 'Ouvrir Enixer help desk Hub dans une nouvelle fenêtre',
	'iTopHub:AutoSubmit' => 'Ne plus me demander. La prochaine fois, aller sur Enixer help desk Hub automatiquement.',
	'UI:About:RemoteExtensionSource' => 'Enixer help desk Hub',
	'iTopHub:Explanation' => 'En cliquant sur ce bouton, vous serez redirigé vers Enixer help desk Hub.',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Une erreur a été détectée durant le déploiement!<br/>La configuration d\'Enixer help desk n\'a PAS été modifiée.',
	...
	'iTopHub:ExtensionCategory:Remote' => 'Extensions déployées depuis Enixer help desk Hub',
	'iTopHub:ExtensionCategory:Remote+' => 'Les extensions ci-dessous ont été déployées depuis Enixer help desk Hub:',
	'iTopHub:NoExtensionInThisCategory' => 'Il n\'y a pas d\'extension dans cette catégorie<br/><br>Avec Enixer help desk Hub trouvez en quelques clics les extensions qui vous permettront de construire un Enixer help desk sur mesure qui se conforme à vos processus.',
	'iTopHub:ExtensionNotInstalled' => 'Non installée',
	'iTopHub:GetMoreExtensions' => 'Obtenir des extensions depuis Enixer help desk Hub...',
	
	'iTopHub:LandingWelcome' => 'Félicitations! Les extensions ci-dessous ont été téléchargées depuis Enixer help desk Hub et installées sur cette instance d\'iTop.',
	'iTopHub:GoBackToITopBtn' => 'Retourner dans Enixer help desk',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Sauvegarde de l\'instance Enixer help desk...',
