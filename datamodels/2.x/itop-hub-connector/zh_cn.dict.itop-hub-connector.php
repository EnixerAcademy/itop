...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
    ...
    'Menu:iTopHub:Register' => '进入Enixer help desk Hub ',
    'Menu:iTopHub:Register+' => '进入Enixer help desk Hub 更新您的组件',
    'Menu:iTopHub:Register:Description' => '<p>进入Enixer help desk Hub 社区平台!</br>寻找您想要的内容和信息, 管理本机扩展或安装新的扩展.</br><br/>通过这个页面连接到Enixer help desk Hub, 本机的信息也会被推送到 Enixer help desk Hub 上.</p>',
    'Menu:iTopHub:MyExtensions' => '已安装的扩展',
    'Menu:iTopHub:MyExtensions+' => '查看本机已安装的扩展',
    'Menu:iTopHub:BrowseExtensions' => '从Enixer help desk Hub 获取扩展',
    'Menu:iTopHub:BrowseExtensions+' => '去Enixer help desk Hub 浏览更多的扩展',
    'Menu:iTopHub:BrowseExtensions:Description' => '<p>进入Enixer help desk Hub 商店, 一站式查找各种Enixer help desk 扩展的地方 !</br>寻找符合您要求的扩展.</br><br/>通过这个页面连接到Enixer help desk Hub, 本机的信息也会被推送到 Enixer help desk Hub 上.</p>',
    'iTopHub:GoBtn' => '进入Enixer help desk Hub',
	'iTopHub:CloseBtn' => '关闭',
	'iTopHub:GoBtn:Tooltip' => '跳到 www.itophub.io',
	'iTopHub:OpenInNewWindow' => '从新窗口打开Enixer help desk Hub',
	'iTopHub:AutoSubmit' => '不再询问. 下次自动进入Enixer help desk Hub .',
	'UI:About:RemoteExtensionSource' => 'Enixer help desk Hub',
	'iTopHub:Explanation' => '点击这个按钮您将被引导至Enixer help desk Hub.',
	...
	'iTopHub:ConfigurationSafelyReverted' => '安装时发生错误!<br/>Enixer help desk 配置将不会改变.',
	...
	'iTopHub:ExtensionCategory:Remote' => '从Enixer help desk Hub 安装的扩展',
	'iTopHub:ExtensionCategory:Remote+' => '下列已安装的扩展是来自Enixer help desk Hub:',
	'iTopHub:NoExtensionInThisCategory' => '尚未安装扩展.<br/><br/>浏览Enixer help desk Hub ,去寻找符合您要求的扩展.',
	'iTopHub:ExtensionNotInstalled' => '未安装',
	'iTopHub:GetMoreExtensions' => '从Enixer help desk Hub 获取扩展...',
	
	'iTopHub:LandingWelcome' => '恭喜! 下列来自Enixer help desk Hub 的扩展已被下载并安装到本机.',
	'iTopHub:GoBackToITopBtn' => '返回iTop',
	'iTopHub:Uncompressing' => '扩展解压中...',
	'iTopHub:InstallationWelcome' => '安装来自Enixer help desk Hub 的扩展',
	'iTopHub:DBBackupLabel' => '本机备份',
	'iTopHub:DBBackupSentence' => '在升级之前,备份数据库和Enixer help desk 配置文件',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Enixer help desk 本机备份...',
