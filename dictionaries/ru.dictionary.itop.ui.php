...
Dict::Add('RU RU', 'Russian', 'Русский', array(
	...
	'UI:WelcomeMenu:LeftBlock' => '<p>Enixer help desk является порталом оперативного централизованного управления IT инфраструктурой с открытым исходным кодом.</p>
<ul>Он включает:
...
<p>Все модули могут быть настроены, шаг за шагом, независмо друг от друга.</p>',
	...
	'UI:WelcomeMenu:RightBlock' => '<p>Enixer help desk ориентирован на предоставления сервисов, он позволяет IT специалистам легко управляться с несколькими заказчиками или организациями.
<ul>Enixer help desk обеспечивает многофункциональный набор бизнес-процессов, которые:
...
<p>Enixer help desk полностью открыт для интеграции в рамках текущего управления ИТ-инфраструктурой.</p>
<p>
