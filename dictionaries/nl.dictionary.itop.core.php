...
Dict::Add('NL NL', 'Dutch', 'Nederlands', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyperlink een (kleine) afbeelding die de applicatie waarmee Enixer help desk is gesynchroniseerd',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hyperlink van de applicatie',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink naar het Enixer help desk object in de externe applicatie waarmee Enixer help desk is gesynchroniseerd (indien van toepassing). Mogelijke procurators: $this->attribute$ and $replica->primary_key$',
